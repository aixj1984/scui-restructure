...
<template>
  <div class="sc-icon-select">
    <div class="sc-icon-select__wrapper" :class="{ hasValue: value }" @click="open">
      <el-input v-model="value" :prefix-icon="value || 'el-icon-plus'" :disabled="disabled" readonly></el-input>
    </div>
      ...
      <div class="sc-icon-select__dialog" style="margin: -20px 0 -10px 0">
        <el-form :rules="{}">
          <el-form-item prop="searchText">
            <el-input v-model="searchText" class="sc-icon-select__search-input" prefix-icon="el-icon-search" placeholder="搜索" size="large" clearable />
          </el-form-item>
        </el-form>
        <el-tabs>
