 ...
 * @LastEditTime: 2023-03-18 13:11:40
-->
  ...
  <div ref="scTableMain" v-loading="loading" class="scTable" :style="{ height: _height }">
    ...
    <div v-if="!hidePagination || !hideDo" class="scTable-page">
      <div class="scTable-pagination">
        <el-pagination v-if="!hidePagination" v-model:currentPage="currentPage" background :small="true" :layout="paginationLayout" :total="total" :page-size="scPageSize" :page-sizes="pageSizes" @current-change="paginationChange" @update:page-size="pageSizeChange"></el-pagination>
      </div>
      <div v-if="!hideDo" class="scTable-do">
        <el-button v-if="!hideRefresh" icon="el-icon-refresh" circle style="margin-left: 15px" @click="refresh"></el-button>
        <el-popover v-if="column" placement="top" title="列设置" :width="500" trigger="click" :hide-after="0" @show="customColumnShow = true" @after-leave="customColumnShow = false">
          ...
          <columnSetting v-if="customColumnShow" ref="columnSetting" :column="userColumn" @userChange="columnSettingChange" @save="columnSettingSave" @back="columnSettingBack"></columnSetting>
        </el-popover>
