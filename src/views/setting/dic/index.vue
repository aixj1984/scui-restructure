<template>
  <el-container>
    <el-aside v-loading="showDicloading" width="300px">
      <el-container>
        <el-header>
          <el-input v-model="dicFilterText" placeholder="输入关键字进行过滤" clearable></el-input>
        </el-header>
    ...
    <el-container class="is-vertical">
      ...
      <el-main class="nopadding">
        <scTable ref="table" :apiObj="listApi" row-key="id" :params="listApiParams" stripe :paginationLayout="'prev, pager, next'" @selection-change="selectionChange">
          ...
          <el-table-column label="是否有效" prop="yx" width="100">
            <template #default="scope">
              <el-switch v-model="scope.row.yx" :loading="scope.row.$switch_yx" active-value="1" inactive-value="0" @change="changeSwitch($event, scope.row)"></el-switch>
            </template>
          </el-table-column>
