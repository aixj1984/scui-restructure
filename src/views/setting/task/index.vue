...
<template>
  <el-main>
    <el-row :gutter="15">
      <el-col v-for="item in list" :key="item.id" :xl="6" :lg="6" :md="8" :sm="12" :xs="24">
  ...
  <el-drawer v-model="dialog.logsVisible" title="计划任务日志" :size="600" direction="rtl" destroy-on-close>
    <logs></logs>
  </el-drawer>
</template>
